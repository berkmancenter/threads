...
ActiveRecord::Schema.define(version: 20190220194550) do
  ...
  create_table "instances", force: :cascade do |t|
    ...
    t.index ["owner_id"], name: "index_instances_on_owner_id", using: :btree
  end
  ...
  create_table "moderatorships", force: :cascade do |t|
    ...
    t.integer "user_id"
    t.index ["instance_id"], name: "index_moderatorships_on_instance_id", using: :btree
    t.index ["user_id"], name: "index_moderatorships_on_user_id", using: :btree
  end
  ...
  create_table "rooms", force: :cascade do |t|
    ...
    t.datetime "updated_at",   null: false
    t.integer  "instance_id"
    t.index ["instance_id"], name: "index_rooms_on_instance_id", using: :btree
